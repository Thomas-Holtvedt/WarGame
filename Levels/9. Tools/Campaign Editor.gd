...
func _ready():
	...
	self.list_players = import_file("res://Levels/1. Grand Campaign/Map/players.txt")
	self.dict_regions = import_file("res://Levels/1. Grand Campaign/Map/regions.txt")
...
func _on_button_region_save_button_up():
	export_file("res://Levels/1. Grand Campaign/Map/regions.txt", dict_regions)
...
func export_file(filepath, my_file):
	...
	file.store_string(content.replace(" ", "_"))
